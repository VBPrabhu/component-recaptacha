...
public class RecaptchaUtil {
    ...
    static {
	    	RECAPTCHA_ERROR_CODE.put("missing-input-secret", 
	    			"The secret parameter is missing :- [missing-input-secret]");
	    	RECAPTCHA_ERROR_CODE.put("invalid-input-secret", 
	    			"The secret parameter is invalid or malformed :- [invalid-input-secret]");
	    	RECAPTCHA_ERROR_CODE.put("missing-input-response", 
	    			"The response parameter is missing :- [missing-input-response]");
	    	RECAPTCHA_ERROR_CODE.put("invalid-input-response", 
	    			"The response parameter is invalid or malformed :- [invalid-input-response]");
	    	RECAPTCHA_ERROR_CODE.put("bad-request", 
	    			"The request is invalid or malformed :- [bad-request]");
    }
}
